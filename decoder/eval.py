...
parser.add_argument("--eval_size", "-es", type=int, default=2000, help="Number of sentences to evaluate")
# parser.add_argument("--use_ngram", "-ng", type=bool, default=False, help="Use ngram decoder or not")
parser.add_argument("--use_ngram", "-ng", type=bool, default=True, help="Use ngram decoder or not")
...
class Evaluator:
    ...
    def load_eval_set(self, debug=True):
        ...
        with open(os.path.join(data_path, 'test-wiki.txt'), 'r', encoding='utf-8') as f:
            lines = f.readlines()
